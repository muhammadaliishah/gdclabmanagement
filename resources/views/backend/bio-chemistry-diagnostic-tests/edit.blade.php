    ...
    <main id="main" class="main">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Edit Bio-Chemistry Diagnostic Test Details</h5>

                        <div class="card">
                            <div class="card-body">

                                {{ Form::model($model->id, array('route' => ['bio-chemistry-diagnostic.update', $model->id], 'target' => '_blank',  'class' => 'form', 'id' => 'edit-tests-form', 'files' => true)) }}
                                {!! method_field('POST') !!}
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label" for="bilirubin_total">Bilirubin
                                                Total:</label>
                                            {{ Form::text('bilirubin_total', $model->bilirubin_total, ['class' => ( 'form-control '. ( $errors->has('bilirubin_total') ? ' is-invalid' : '' )), 'id' => 'bilirubin_total']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('ALT_SGPT', $model->ALT_SGPT, ['class' => ( 'form-control '. ( $errors->has('ALT_SGPT') ? ' is-invalid' : '' )), 'id' => 'ALT_SGPT']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('AST_SPOT', $model->AST_SGOT, ['class' => ( 'form-control '. ( $errors->has('AST_SPOT') ? ' is-invalid' : '' )), 'id' => 'AST_SPOT']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label" for="alkaline_phosphatase">Alkaline
                                                Phosphatase
                                                (ALP):</label>
                                            {{ Form::text('alkaline_phosphatase', $model->alkaline_phosphatase, ['class' => ( 'form-control '. ( $errors->has('alkaline_phosphatase') ? ' is-invalid' : '' )), 'id' => 'alkaline_phosphatase']) }}
                                            <div class="invalid-feedback">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('blood_urea', $model->blood_urea, ['class' => ( 'form-control '. ( $errors->has('blood_urea') ? ' is-invalid' : '' )), 'id' => 'blood_urea']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('creatinine', $model->creatinine, ['class' => ( 'form-control '. ( $errors->has('creatinine') ? ' is-invalid' : '' )), 'id' => 'creatinine']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('uric_acid', $model->uric_acid, ['class' => ( 'form-control '. ( $errors->has('uric_acid') ? ' is-invalid' : '' )), 'id' => 'uric_acid']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('cholesterol', $model->cholesterol, ['class' => ( 'form-control '. ( $errors->has('cholesterol') ? ' is-invalid' : '' )), 'id' => 'cholesterol']) }}
                                            <div class="invalid-feedback">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('triglycerides', $model->triglycerides, ['class' => ( 'form-control '. ( $errors->has('triglycerides') ? ' is-invalid' : '' )), 'id' => 'triglycerides']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label" for="HDL_cholesterol">HDL
                                                Cholesterol:</label>
                                            {{ Form::text('HDL_cholesterol', $model->HDL_cholesterol, ['class' => ( 'form-control '. ( $errors->has('HDL_cholesterol') ? ' is-invalid' : '' )), 'id' => 'HDL_cholesterol']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label" for="LDL_cholesterol">LDL
                                                Cholesterol:</label>
                                            {{ Form::text('LDL_cholesterol', $model->LDL_cholesterol, ['class' => ( 'form-control '. ( $errors->has('LDL_cholesterol') ? ' is-invalid' : '' )), 'id' => 'LDL_cholesterol']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('LDH', $model->LDH, ['class' => ( 'form-control '. ( $errors->has('LDH') ? ' is-invalid' : '' )), 'id' => 'LDH']) }}
                                            <div class="invalid-feedback">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('sodium', $model->sodium, ['class' => ( 'form-control '. ( $errors->has('sodium') ? ' is-invalid' : '' )), 'id' => 'sodium']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('potassium', $model->potassium, ['class' => ( 'form-control '. ( $errors->has('potassium') ? ' is-invalid' : '' )), 'id' => 'potassium']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('chloride', $model->chloride, ['class' => ( 'form-control '. ( $errors->has('chloride') ? ' is-invalid' : '' )), 'id' => 'chloride']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('BUN', $model->BUN, ['class' => ( 'form-control '. ( $errors->has('BUN') ? ' is-invalid' : '' )), 'id' => 'BUN']) }}
                                            <div class="invalid-feedback">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('calcium', $model->calcium, ['class' => ( 'form-control '. ( $errors->has('calcium') ? ' is-invalid' : '' )), 'id' => 'calcium']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label" for="glucose_fasting">Glucose
                                                (Fasting):</label>
                                            {{ Form::text('glucose_fasting', $model->glucose_fasting, ['class' => ( 'form-control '. ( $errors->has('glucose_fasting') ? ' is-invalid' : '' )), 'id' => 'glucose_fasting']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('glucose_random', $model->glucose_random, ['class' => ( 'form-control '. ( $errors->has('glucose_random') ? ' is-invalid' : '' )), 'id' => 'glucose_random']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('serum_albumin', $model->serum_albumin, ['class' => ( 'form-control '. ( $errors->has('serum_albumin') ? ' is-invalid' : '' )), 'id' => 'serum_albumin']) }}
                                            <div class="invalid-feedback">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('GCT', $model->GCT, ['class' => ( 'form-control '. ( $errors->has('GCT') ? ' is-invalid' : '' )), 'id' => 'GCT']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('OGTT', $model->OGTT, ['class' => ( 'form-control '. ( $errors->has('OGTT') ? ' is-invalid' : '' )), 'id' => 'OGTT']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('first_hour', $model->first_hour, ['class' => ( 'form-control '. ( $errors->has('first_hour') ? ' is-invalid' : '' )), 'id' => 'first_hour']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('second_hour', $model->second_hour, ['class' => ( 'form-control '. ( $errors->has('second_hour') ? ' is-invalid' : '' )), 'id' => 'second_hour']) }}
                                            <div class="invalid-feedback">
