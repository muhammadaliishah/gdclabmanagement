    ...
    <main id="main" class="main">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Edit Urine Test Details</h5>

                        <div class="card">
                            <div class="card-body">

                                {{ Form::model($model->id, array('route' => ['urine-tests.update', $model->id], 'target' => '_blank',  'class' => 'form', 'id' => 'edit-urine-tests-form', 'files' => true)) }}
                                {!! method_field('POST') !!}
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('appearance', $model->appearance, ['class' => ( 'form-control '. ( $errors->has('appearance') ? ' is-invalid' : '' )), 'id' => 'appearance']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label" for="specific_gravity">Specific
                                                Gravity:</label>
                                            {{ Form::text('specific_gravity', $model->specific_gravity, ['class' => ( 'form-control '. ( $errors->has('specific_gravity') ? ' is-invalid' : '' )), 'id' => 'specific_gravity']) }}
                                            <div class="invalid-feedback">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('protein', $model->protein, ['class' => ( 'form-control '. ( $errors->has('protein') ? ' is-invalid' : '' )), 'id' => 'protein']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('glucose', $model->glucose, ['class' => ( 'form-control '. ( $errors->has('glucose') ? ' is-invalid' : '' )), 'id' => 'glucose']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('ketones', $model->ketones, ['class' => ( 'form-control '. ( $errors->has('ketones') ? ' is-invalid' : '' )), 'id' => 'ketones']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('bilirubin', $model->bilirubin, ['class' => ( 'form-control '. ( $errors->has('bilirubin') ? ' is-invalid' : '' )), 'id' => 'bilirubin']) }}
                                            <div class="invalid-feedback">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('nitrite', $model->nitrite, ['class' => ( 'form-control '. ( $errors->has('nitrite') ? ' is-invalid' : '' )), 'id' => 'nitrite']) }}
                                            <div class="invalid-feedback">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label" for="epithelial_cells">Epithelial
                                                Cells:</label>
                                            {{ Form::text('epithelial_cells', $model->epithelial_cells, ['class' => ( 'form-control '. ( $errors->has('epithelial_cells') ? ' is-invalid' : '' )), 'id' => 'epithelial_cells']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('casts', $model->cast, ['class' => ( 'form-control '. ( $errors->has('casts') ? ' is-invalid' : '' )), 'id' => 'casts']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('bacteria', $model->bacteria, ['class' => ( 'form-control '. ( $errors->has('bacteria') ? ' is-invalid' : '' )), 'id' => 'bacteria']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label" for="calcium_oxalate">Calcium
                                                Oxalate:</label>
                                            {{ Form::text('calcium_oxalate', $model->calcium_oxalate, ['class' => ( 'form-control '. ( $errors->has('calcium_oxalate') ? ' is-invalid' : '' )), 'id' => 'calcium_oxalate']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label" for="amorphous_urates">Amorphous
                                                Urates:</label>
                                            {{ Form::text('amorphous_urates', $model->amorphous_urates, ['class' => ( 'form-control '. ( $errors->has('amorphous_urates') ? ' is-invalid' : '' )), 'id' => 'amorphous_urates']) }}
                                            <div class="invalid-feedback">
