    ...
    <main id="main" class="main">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Add New Urine Pregnancy Test</h5>

                        <div class="card">
                            <div class="card-body">

                                {{ Form::open(array('route' => 'urine-pregnancy.store', 'target' => '_blank',  'class' => 'form', 'id' => 'create-tests-form', 'files' => true)) }}
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label" for="urine_pregnancy_test">Urine Pregnancy Test
                                                (UPT):</label>
                                            {{ Form::text('urine_pregnancy_test', NULL, ['class' => ( 'form-control '. ( $errors->has('urine_pregnancy_test') ? ' is-invalid' : '' )), 'id' => 'urine_pregnancy_test']) }}
                                            <div class="invalid-feedback">
