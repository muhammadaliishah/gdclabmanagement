    ...
    <main id="main" class="main">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Add New ABO Blood Group Test</h5>

                        <div class="card">
                            <div class="card-body">

                                {{ Form::model($model->id, array('route' => ['abo-blood-group.update', $model->id], 'target' => '_blank', 'class' => 'form', 'id' => 'edit-tests-form', 'files' => true)) }}
                                {!! method_field('POST') !!}
                        ...
                        <div class="card mt-5">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">ABO Blood Group Test Results</h5>

                                <div class="row mt-3">

                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label" for="abo_blood_group">ABO Blood Group:</label>
                                            {{ Form::text('abo_blood_group', $model->ABO_blood_group, ['class' => ( 'form-control '. ( $errors->has('abo_blood_group') ? ' is-invalid' : '' )), 'id' => 'abo_blood_group']) }}
                                            <div class="invalid-feedback">
                                                {{ $errors->has('abo_blood_group') ? $errors->first('abo_blood_group') : '' }}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label" for="RH_type">RH Type:</label>
                                            {{ Form::text('RH_type', $model->RH_type, ['class' => ( 'form-control '. ( $errors->has('RH_type') ? ' is-invalid' : '' )), 'id' => 'RH_type']) }}
                                            <div class="invalid-feedback">
                                                {{ $errors->has('RH_type') ? $errors->first('RH_type') : '' }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
