            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        {{ Form::model($model->id, array('route' => ['doctors.update', $model->id], 'class' => 'form', 'id' => 'edit-account-form', 'files' => true)) }}
                        {!! method_field('POST') !!}
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('specialist', $model->specialist, ['class' => ( 'form-control '. ( $errors->has('specialist') ? ' is-invalid' : '' )), 'id' => 'specialist']) }}
                                    <div class="invalid-feedback">
