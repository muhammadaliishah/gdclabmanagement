    ...
    <main id="main" class="main">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Add New Bilirubin Bio-Chemistry Test</h5>

                        <div class="card">
                            <div class="card-body">

                                {{ Form::open(array('route' => 'bilirubin-bio-chemistry.store', 'target' => '_blank',  'class' => 'form', 'id' => 'create-tests-form', 'files' => true)) }}
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('total_bilirubin', NULL, ['class' => ( 'form-control '. ( $errors->has('total_bilirubin') ? ' is-invalid' : '' )), 'id' => 'total_bilirubin']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label" for="bilirubin_direct">Bilirubin
                                                Direct:</label>
                                            {{ Form::text('bilirubin_direct', NULL, ['class' => ( 'form-control '. ( $errors->has('bilirubin_direct') ? ' is-invalid' : '' )), 'id' => 'bilirubin_direct']) }}
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label" for="bilirubin_indirect">Bilirubin
                                                In-Direct:</label>
                                            {{ Form::text('bilirubin_indirect', NULL, ['class' => ( 'form-control '. ( $errors->has('bilirubin_indirect') ? ' is-invalid' : '' )), 'id' => 'bilirubin_indirect']) }}
                                            <div class="invalid-feedback">
