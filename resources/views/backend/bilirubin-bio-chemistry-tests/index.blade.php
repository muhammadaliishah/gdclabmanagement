                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                            ...
                            <div class="col-11">
                                <h5 class="card-title">Bilirubin Bio Chemistry (Direct & In-Direct) Tests Details</h5>
                            </div>

                            <div class="col-1">
                                <a class="btn btn-primary"
                                   href="{{route('bilirubin-bio-chemistry.create')}}"> New
                                ...
                                @forelse($models as $model)
                                    <tr>
                                        ...
                                        <td class="cell"><a class="btn btn-primary"
                                                            href="{{route('bilirubin-bio-chemistry.edit', $model->id)}}">Edit</a>
                                        </td>
                                    </tr>
