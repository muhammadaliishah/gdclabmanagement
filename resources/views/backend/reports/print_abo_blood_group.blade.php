<html lang="en">
<head>
    <title>Print ABO BLOOD GROUP TEST</title>
...
<div class="row" style="width: 750px">
    ...
    <div class="row mt-3 mb-3">
        ...
        <div class="col-4">
            <h6>Investigation: <u>BLOOD GROUP</u></h6>
        </div>
    ...
    <div class="container mt-2">
        <table class="table table-bordered " style="border-bottom: 1px solid gray; border-top: 1px solid gray;">
            ...
            @if(!empty($model->ABO_blood_group))
                <tr>
                    ...
                    <td style="width: 100px;" class="text-center">
                        <b> "{{$model->abo_blood_group_display ?? 'NA'}}"</b>
                    </td>

                </tr>
            @endif

            @if(!empty($model->RH_type))
                <tr>
